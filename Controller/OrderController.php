...
class OrderController
{
    public function listOrders() {
        try {
            $pdo = config::getConnexion(); // Utilisez config de manière cohérente
    ...
    function addOrder($order) {
        $sql = "INSERT INTO orders (client_name, product, address, postal_code, phone, id_basket)
                VALUES (:client_name, :product, :address, :postal_code, :phone, :id_basket)";
        $db = config::getConnexion();
