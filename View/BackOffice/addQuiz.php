...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!in_array($level, ['1', '2', '3'])) {
        $errors['level'] = "Level must be one of the values: 1, 2, or 3.";
    }
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO quizzes (course_id, subject_id, question, option_a, option_b, option_c, option_d, correct_option, level)
        VALUES (:course_id, :subject_id, :question, :option_a, :option_b, :option_c, :option_d, :correct_option, :level)";
...
<body>
    <div class="dashboard-main-wrapper">
        ...
        <select class="form-control" id="level" name="level" required>
            ...
            <option value="1" <?= (isset($level) && $level == '1') ? 'selected' : ''; ?>>1</option>
            <option value="2" <?= (isset($level) && $level == '2') ? 'selected' : ''; ?>>2</option>
            <option value="3" <?= (isset($level) && $level == '3') ? 'selected' : ''; ?>>3</option>
        </select>
