                ...
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($currentPage === 'products.php' || $currentPage === 'orders.php') ? 'active' : ''; ?>" 
                           href="products.php" data-toggle="collapse" aria-expanded="<?php echo ($currentPage === 'products.php' || $currentPage === 'orders.php') ? 'true' : 'false'; ?>" 
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($currentPage === 'user-management.php') ? 'active' : ''; ?>" href="user-management.php" data-toggle="collapse" aria-expanded="<?php echo ($currentPage === 'user-management.php') ? 'true' : 'false'; ?>" 
                           data-target="#submenu-user-management" aria-controls="submenu-user-management">
                            <i class="fa fa-fw fa-users"></i>User Management
                        </a>
                        <div id="submenu-user-management" class="collapse submenu <?php echo ($currentPage === 'user-management.php') ? 'show' : ''; ?>">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link <?php echo ($currentPage === 'user-management.php') ? 'active' : ''; ?>" href="user-management.php">Manage Users</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>ecole manzah9</td>
                                                <td>
                                                    <a href="modify-user.php" class="btn btn-primary btn-sm">Edit</a>
