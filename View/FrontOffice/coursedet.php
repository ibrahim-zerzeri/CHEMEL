        ...
        <div class="course-content">
            ...
            <?php if ($courseDetails['pdf_file']): ?>
                ...
                <button class="futuristic-button" id="downloadPdfBtn">
                    <a href="../BackOffice/<?php echo htmlspecialchars($courseDetails['pdf_file']); ?>" download>
                        Download PDF
                    </a>
                </button>
...
<!-- chatbot -->
<script> window.chtlConfig = { chatbotId: "6214487439" } </script>
<script async data-id="6214487439" id="chatling-embed-script" type="text/javascript" src="https://chatling.ai/js/embed.js"></script>
